...
class _TestPageState extends State<TestPage> {
  ...
  // Future<String> getCal() async {
  //   ApiService apiService =
  //       new ApiService('apple', dio.Dio(), baseUrl: "http://10.0.2.2:8000/");
  //   final response = await apiService.calorie();
  //   setState(() {
  //     cal = response.calorie.toString();
  //
  //   });
  //   return response.calorie.toString();
  // }
